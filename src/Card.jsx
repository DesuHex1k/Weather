...
const Card = () => {
    ...
    return (
        <StyledWrapper>
            ...
            <div className="cardm">
                <div className="card">
                    <img className='weather' src={`https://openweathermap.org/img/wn/${ico}@2x.png`} alt="" />
                    <div className="main">{Math.round(main.temp)} °C</div>
                    <div className="mainsub">{city}</div>
                </div>
                <div className="card2">
                    <div className="upper">
                        <div className="humidity">
                            <div className="humiditytext">Humidity<br />{main.humidity}</div>
          ...
          KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" y={0} x={0} height={30} width={30} id="image0" />
                        ...
                        <div className="air">
                            <div className="airtext">Wind<br />{wind.speed} m/s</div>
                    ...
                    <div className="lower">
                        <div className="aqi">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                 className="bi bi-clouds" viewBox="0 0 16 16">
                                <path
                            ...
                            <div className="aqitext">cloud<br/>{cloud.all}%</div>
                        </div>
                        <div className="realfeel">
                            <svg className="rfsvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px"
          ...
          OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII=" />
                            ...
                            <div className="realfeeltext">Real Feel<br />{Math.round(main.feels_like)} °C</div>
                        </div>
          ...
          Ut8AAAAASUVORK5CYII=" />
                            ...
                            <div className="pressuretext">Pressure<br />{main.pressure} bar</div>
                        </div>
                        {/*<div className="card3">*/}
                        {/*    Healthy*/}
                        {/*</div>*/}
            ...
            <Button style={{marginTop: "1em"}} onClick={() => setCity(input)}/>
        </StyledWrapper>
    );
}
...
const StyledWrapper = styled.div`
    ...
    height: 100vh; /* Чтобы все центрировалось по высоте */

    .cardm {
        display: flex;
        align-items: center;
        justify-content: center;
        position: relative; /* Лучше убрать absolute */
        margin-bottom: 1em;
    }
